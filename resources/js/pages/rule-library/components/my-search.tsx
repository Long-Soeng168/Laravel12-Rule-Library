    ...
    <div className="bg-[#393838] pb-2">
      <div className="max-w-screen-2xl mx-auto px-3 sm:px-10 lg:px-20 py-3">
        ...
        <form
          ...
          method="GET"
          className="mt-3 bg-white min-w-xs max-w-screen-2xl flex md:flex-row items-center justify-center border pl-2 rounded-full gap-2 shadow-2xl focus-within:border-gray-300"
        >
