    ...
    return (
        <section className="mx-auto max-w-screen-2xl px-4 py-14 lg:px-20">
            ...
            <div className="mb-10 text-center max-w-4xl mx-auto">
                ...
                <p className="mt-2 text-gray-500 dark:text-gray-300">Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias necessitatibus ipsam itaque deleniti distinctio dolore. Quam, doloribus aperiam nam iusto, omnis corporis ipsam, vero deserunt quae vel officia neque culpa.</p>
            </div>
